...
const mockGetUtilisationRequest = getUtilisationRequest as jest.MockedFunction<
  typeof getUtilisationRequest
>;
const mockGetUtilisationRequestResponse =
  getUtilisationRequestResponse as jest.MockedFunction<
    typeof getUtilisationRequestResponse
  >;
...
describe("GetUtilisationResolver", () => {
  ...
  describe("Query.getUtilisation", () => {
    it("should successfully fetch utilisation data", async () => {
      ...
      expect(mockGetUtilisationRequestResponse).toHaveBeenCalledWith(
        mockUtilisations,
      );
