...
describe("Prisma Utils", () => {
  ...
  describe("UtilisationCalculation Model Operations", () => {
    it("should call findMany with correct parameters", async () => {
      ...
      mockPrismaClient.utilisationCalculation.findMany.mockResolvedValue(
        mockCalculations,
      );
    ...
    it("should call create with correct calculation data", async () => {
      ...
      mockPrismaClient.utilisationCalculation.create.mockResolvedValue(
        mockCreatedCalculation,
      );

      const result = await prisma.utilisationCalculation.create({
        data: calculationData,
      });

      expect(prisma.utilisationCalculation.create).toHaveBeenCalledWith({
        data: calculationData,
      });
