...
const mockEnsureAuthHeaderIsProvided = ensureAuthHeaderIsProvided as jest.MockedFunction<typeof ensureAuthHeaderIsProvided>
const mockEnsureSecretKeyIsConfigured = ensureSecretKeyIsConfigured as jest.MockedFunction<typeof ensureSecretKeyIsConfigured>
const mockEnsureTokenIsValid = ensureTokenIsValid as jest.MockedFunction<typeof ensureTokenIsValid>
...
describe('validateAuthRequest', () => {
  ...
  it('should throw error when validation fails', () => {
    ...
    expect(() => validateAuthRequest(undefined, 'token', 'secret'))
