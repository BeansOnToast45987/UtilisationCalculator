...
const mockCreateClerkClient = createClerkClient as jest.MockedFunction<typeof createClerkClient>
const mockValidateAuthRequest = validateAuthRequest as jest.MockedFunction<typeof validateAuthRequest>
