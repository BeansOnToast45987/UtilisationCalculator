...
describe("CustomProgressBar", () => {
  ...
  it("applies determinate variant with value", () => {
    render(
      <CustomProgressBar value={60} color="success" variant="determinate" />,
    );
    ...
    expect(progressBar).toHaveAttribute(
      "class",
      expect.stringContaining("custom-progress-bar"),
    );
  });

  it("applies indeterminate variant", () => {
    render(
      <CustomProgressBar value={100} color="error" variant="indeterminate" />,
    );
