...
describe("ensureCountryIsProvided", () => {
  ...
  it("should throw error when country is undefined", () => {
    expect(() => ensureCountryIsProvided(undefined)).toThrow(
      "Country is Required",
    );
  });

  it("should throw error when country is null", () => {
    expect(() => ensureCountryIsProvided(null)).toThrow("Country is Required");
  });

  it("should throw error when country is empty string", () => {
    expect(() => ensureCountryIsProvided("")).toThrow("Country is Required");
  });

  it("should throw error when country is false", () => {
    expect(() => ensureCountryIsProvided(false)).toThrow("Country is Required");
  });

  it("should throw error when country is 0", () => {
    expect(() => ensureCountryIsProvided(0)).toThrow("Country is Required");
  });
