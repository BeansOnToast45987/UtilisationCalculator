...
const mockEnsureClerkIdIsProvided = ensureClerkIdIsProvided as jest.MockedFunction<typeof ensureClerkIdIsProvided>
const mockEnsureClerkIdMatches = ensureClerkIdMatches as jest.MockedFunction<typeof ensureClerkIdMatches>
const mockEnsureCountryIsProvided = ensureCountryIsProvided as jest.MockedFunction<typeof ensureCountryIsProvided>
const mockEnsureCountryIsValidEnum = ensureCountryIsValidEnum as jest.MockedFunction<typeof ensureCountryIsValidEnum>
const mockEnsureFirstNameIsProvided = ensureFirstNameIsProvided as jest.MockedFunction<typeof ensureFirstNameIsProvided>
const mockEnsureFullNameIsProvided = ensureFullNameIsProvided as jest.MockedFunction<typeof ensureFullNameIsProvided>
const mockEnsureLastNameIsProvided = ensureLastNameIsProvided as jest.MockedFunction<typeof ensureLastNameIsProvided>
...
describe('validateInitializeUserInput', () => {
  ...
  it('should call all validation functions with correct parameters', () => {
    ...
    expect(mockEnsureClerkIdMatches).toHaveBeenCalledWith('user_123', 'user_123')
  ...
  it('should throw error when clerkId validation fails', () => {
    ...
    expect(() => validateInitializeUserInput(mockInput, authenticatedClerkId))
