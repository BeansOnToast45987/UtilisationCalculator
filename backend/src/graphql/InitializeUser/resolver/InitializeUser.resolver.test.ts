...
const mockValidateInitializeUserInput = validateInitializeUserInput as jest.MockedFunction<typeof validateInitializeUserInput>
const mockInitializeUserRequest = initializeUserRequest as jest.MockedFunction<typeof initializeUserRequest>
const mockInitializeUserRequestResponse = initializeUserRequestResponse as jest.MockedFunction<typeof initializeUserRequestResponse>
...
describe('InitializeUserResolver', () => {
  ...
  describe('Mutation.initializeUser', () => {
    it('should successfully create a new user', async () => {
      ...
      expect(mockValidateInitializeUserInput).toHaveBeenCalledWith(mockInput, 'user_123')
